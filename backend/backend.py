...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:8000", "http://localhost:5000","http://34.93.114.151:8000"],  ##the url that is allowed to send request
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("backend:backend_app", port=5000, reload=True)
